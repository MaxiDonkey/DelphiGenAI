...
- [CRUD operations on saved chat completions](https://github.com/MaxiDonkey/DelphiGenAI/blob/main/ChatCompletion.md#crud-operations-on-saved-chat-completions)
___
