...
type
  ...
  /// <summary>
  /// Manages asynchronous chat callBacks for a chat request using <c>TRunStep</c> as the response type.
  /// </summary>
  /// <remarks>
  ...
  /// <summary>
  /// Manages asynchronous chat callBacks for a chat request using <c>TRunSteps</c> as the response type.
  /// </summary>
  /// <remarks>
